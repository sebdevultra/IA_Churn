...
class FrictionItem(BaseModel):
    ...
    def validate_category(cls, v: str) -> str:
        valid = {
            ...
            "usability", "billing", "onboarding", "performance",
            "billing_pricing", "sla_delay", "feature_gap", "security_privacy", "other"
        }
...
class AIAnalysisOutput(BaseModel):
    ...
    is_sarcastic: bool = Field(default=False, description="Whether sarcasm or irony was detected in customer feedback")
