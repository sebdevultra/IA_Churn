...
class InvalidContentFormatError(AppBaseException):
    """Raised when file or payload content format is invalid."""
    def __init__(self, message: str = "Formato de contenido o archivo inválido."):
