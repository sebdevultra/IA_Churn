    ...
    this.mockState = {
      ...
      highRiskCases: [
        ...
        },
        {
          ...
          rawEvidence: 'Pésima atención del ejecutivo asignado. Si no solucionan la falla de la API antes del viernes evaluaremos migrar.',
          maskedEvidence: 'Pésima atención del ejecutivo asignado. Si no solucionan la falla de la API antes del viernes evaluaremos migrar.',
          status: 'IN_REVIEW',
          aiEngine: 'cloud_gemini',
          scoreFactors: [
            { factor: 'Riesgo de migración a competidores', impact: 40 },
            { factor: 'Evaluación negativa de atención', impact: 24 },
            { factor: 'Impacto en Integraciones Críticas', impact: 20 }
          ],
        ...
        },
        {
          ...
          rawEvidence: 'No puedo exportar los reportes mensuales en PDF, la pantalla se queda congelada.',
          maskedEvidence: 'No puedo exportar los reportes mensuales en PDF, la pantalla se queda congelada.',
          status: 'PENDING',
          aiEngine: 'local_nlp',
          scoreFactors: [
            { factor: 'Fallo de funcionalidad clave', impact: 35 },
            { factor: 'Experiencia de usuario degradada', impact: 30 }
          ],
          timestamp: '2026-08-18T18:00:00Z'
        },
        {
          id: 'ALT-1072',
          customerName: 'InnovaSoft Cloud',
          tier: 'Pro',
          riskScore: 45,
          emotion: 'neutral',
          friction: 'feature_gap',
          rawEvidence: 'Sería excelente contar con autenticación SSO mediante Okta para todo el equipo.',
          maskedEvidence: 'Sería excelente contar con autenticación SSO mediante Okta para todo el equipo.',
          status: 'RESOLVED',
          aiEngine: 'cloud_gemini',
          scoreFactors: [
            { factor: 'Solicitud de característica ausente', impact: 25 },
            { factor: 'Sentimiento Neutro/Constructivo', impact: 20 }
          ],
